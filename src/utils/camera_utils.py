...
class Camera(nn.Module):
    def __init__(
        ...
        # Contribution 3: Beta EMA for trend-aware uncertainty weighting
        # Tracks exponential moving average of uncertainty to detect recovering patches
        self.beta_ema = None  # Shape [H/14, W/14], initialized on first uncertainty pass

        # Privacy-preserving SLAM: mask of detected private regions for this frame
        # Shape (H, W), values in [0, 1] where 1 = private region
